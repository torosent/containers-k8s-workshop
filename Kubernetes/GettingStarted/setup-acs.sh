...
az group create --name PRK8sCluster --location eastus
...
az acs create --orchestrator-type kubernetes --resource-group PRK8sCluster --name promanK8sCluster --agent-count 2 --ssh-key-value ~/.ssh/id_rsa.pub
...
az acs kubernetes get-credentials --resource-group=PRK8sCluster --name=promanK8sCluster
